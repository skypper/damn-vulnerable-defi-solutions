...
describe('[Challenge] The rewarder', function () {
    ...
    it('Execution', async function () {
        ...
        const theRewarderAttackerFactory = await ethers.getContractFactory("TheRewarderAttacker", player);
        const theRewarderAttacker = await theRewarderAttackerFactory.deploy(flashLoanPool.address, rewarderPool.address, liquidityToken.address, rewardToken.address);
        await theRewarderAttacker.connect(player).attack();
    });
